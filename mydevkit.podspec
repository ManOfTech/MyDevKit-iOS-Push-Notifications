...
Pod::Spec.new do |s|
  s.name             = 'mydevkit'
  s.version          = '0.0.2'
  s.summary          = 'A short description of mydevkit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/laynefaler@gmail.com/mydevkit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'laynefaler@gmail.com' => 'laynefaler@gmail.com' }
  s.source           = { :git => 'https://github.com/laynefaler@gmail.com/mydevkit.git', :tag => s.version.to_s }
